...
setup(
    name='topology_lib_diag',
    version=find_version('lib/topology_lib_diag/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url='https://github.com/HPENetworking/topology_lib_diag/tree/master/doc',
    keywords='topology_lib_diag',
    ...
    entry_points={
        'topology_library_10': [
            'diag = topology_lib_diag.library'
        ]
    }
)
